...
const TransactionSummary = ({ transactions }) => {
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
      {[
        { title: "Today's Sales", value: `₱${summary.todaySales.toLocaleString('en-PH', { minimumFractionDigits: 2 })}`, color: "text-green-600" },
        { title: "Total Transactions", value: summary.totalTransactions, color: "text-blue-600" },
        { title: "Average Transaction", value: `₱${summary.avgTransaction.toLocaleString('en-PH', { minimumFractionDigits: 2 })}`, color: "text-orange-600" },
        { title: "Most Popular Payment", value: summary.popularPayment, color: "text-purple-600" }
      ].map((stat, index) => (
      ...
      <div className="bg-gradient-to-r from-orange-100/80 to-amber-100/30 rounded-xl p-4 sm:p-6 mb-6">
        <div className="flex flex-col md:flex-row justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">Cashier Transaction</p>
          </div>
          <div className="flex items-center gap-4">
            <div className="relative">
              <button className="flex items-center px-4 py-2 bg-white border rounded-lg text-sm font-medium shadow-sm hover:bg-gray-50">
